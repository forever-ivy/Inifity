...
FALLBACK_MODEL="${OPENCLAW_FALLBACK_MODEL:-deepseek-v3-2/DeepSeek}"
IMAGE_MODEL="${OPENCLAW_IMAGE_MODEL:-$PRIMARY_MODEL}"
FALLBACK_CHAIN="${OPENCLAW_FALLBACK_CHAIN:-deepseek-v3-2/DeepSeek,openai-codex/gpt-5.3-codex,google-antigravity/gemini-3-flash}"
